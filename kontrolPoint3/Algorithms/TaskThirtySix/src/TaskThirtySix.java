...
public class TaskThirtySix {
    public static void main(String[] args){
        String line = new TaskThirtySix().userPutString();
        String wordKey = new TaskThirtySix().userPutStringKey();
        char[] matrixWords = new  TaskThirtySix().matrixWords();
...
//нжкжэж
//нжкжэжфцйжуонжьооифчфзлууфчшо
//бъюъсъ икэъзвбървв ь илиыяззилмв